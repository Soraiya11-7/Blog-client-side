        ...
        <div className="home-container">
          ...
          <section className="tips-section bg-gray-100 py-10">
            <div className="container mx-auto px-6">
              {/* Title Animation */}
              <motion.h2 
                className="text-4xl font-extrabold text-center mb-6 text-blue-600 tracking-wide" 
              ...
              {/* Subtitle Animation */}
              <motion.p 
                className="text-lg text-center text-gray-700 mb-8 leading-relaxed" 
                initial={{ opacity: 0 }} 
                animate={{ opacity: 1 }} 
              ...
              >
                <motion.li 
                  className="tip-card bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 text-white p-8 rounded-lg shadow-xl relative transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
                ...
                >
                  ...
                  <h3 className="font-bold text-2xl mb-4 tracking-wide mt-4">
                    Consistency is Key
                  </h3>
                ...
                <motion.li 
                  className="tip-card bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 text-white p-8 rounded-lg shadow-xl relative transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
                  initial={{ opacity: 0, y: 20 }} 
                  animate={{ opacity: 1, y: 0 }} 
                ...
                <motion.li 
                  className="tip-card bg-gradient-to-r from-yellow-500 via-red-500 to-pink-400 text-white p-8 rounded-lg shadow-xl relative transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
                  initial={{ opacity: 0, y: 20 }} 
                  animate={{ opacity: 1, y: 0 }} 
